    ...
    return (
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center py-16">
          ...
          <h1 className="text-4xl font-bold text-gray-600 mb-4">Calendario de Partidos</h1>
  ...
  return (
    <div className="max-w-6xl mx-auto px-4">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-800 mb-4">Calendario de Partidos</h1>
      </div>
